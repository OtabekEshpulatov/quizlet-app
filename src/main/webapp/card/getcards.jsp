                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">${card.getTerm()}</li>
                            <li class="list-group-item">${card.getDescription()}</li>
                        </ul>
                            <button type="submit" class="btn btn-link" href="/editcard" name="button1" value="update/${card.getId()}"><i>Edit</i></button>
                            <button type="submit" class="btn btn-link" href="/deletecard" name="button2" value="delete/${card.getId()}"><i>Delete</i></button>
                        </form>
                    </div>
                </div>
            </c:forEach>
