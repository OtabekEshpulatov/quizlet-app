                        ...
                        <form id="login" method="post" action="/login">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" required
                                       data-validation-required-message="Please enter your password" autocomplete="on"
                                       name="loginpassword">
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="mrgn-30-top">
                                ...
                                <span style="color: red;margin-top: 5px">Doesn't have account <a href="/signup">Register</a></span>
                            </div>
                        </form>
                    </div>

                    <div class="tab-pane fade active in" id="signup">
                        <h2 class="text-uppercase text-center"> Sign Up Page <span>${credentials}</span></h2>
                        <form id="signup" method="post" action="/signup">
                            <div class="form-group">
                                <label> Your Email <span
                                        style="color: red">:${signup_credentials.get("signupemail_error")}</span><span
                            ...
                            <div class="form-group">
                                <label> Your username <span
                                        style="color: red">:${signup_credentials.get("signupusername_error")}</span>
                            ...
                            <div class="form-group">
                                <label> Password <span
                                        style="color: red">:${signup_credentials.get("signuppassword_error")}</span><span
                                        class="req">*</span> </label>
                                <input type="password" class="form-control" id="password" required
